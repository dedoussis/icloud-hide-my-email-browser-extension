...
import './style.css';
import { getBrowserStorageValue } from '@/src/storage';
        ...
        case MessageType.GenerateResponse:
          {
            ...
            if (!element || !(element instanceof HTMLButtonElement)) break;
            if (error) {
        ...
        case MessageType.ReservationResponse:
          {
            ...
            if (!btnElement || !(btnElement instanceof HTMLButtonElement)) break;
            if (error) {
